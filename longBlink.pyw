...
class Window(QWidget): 
    def __init__(self): 
        ...
        parser.add_argument("count", nargs="?", type=int, default=9, help="Целое число от 1 до 9 (по умолчанию: 1)")
    ...
    # 5. Индикаторы предстоящих вызовов
        # Отключить для longBlink, если count=0
        if count > 0:
